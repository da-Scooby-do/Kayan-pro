  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-14 h-px bg-gradient-to-r from-transparent via-kayan-gold/50 to-transparent mx-auto mt-5" />
      </motion.div>
      ...
      >
        ...
        <div className="flex rounded-xl overflow-hidden border border-white/[0.07] mb-7">
          {[
            ...
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium transition-all duration-200 cursor-pointer border-none
                ${mode === m.id
        ...
        {/* Admin hint */}
        <p className="text-center text-[10px] text-kayan-muted mt-5">
          Admin access is configured via Supabase roles.
        </p>
      </motion.div>
